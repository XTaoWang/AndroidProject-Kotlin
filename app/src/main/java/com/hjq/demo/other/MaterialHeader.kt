...
class MaterialHeader @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null) :
    ...
    init {
        ...
        val typedArray: TypedArray = context.obtainStyledAttributes(attrs, com.scwang.smart.refresh.header.material.R.styleable.MaterialHeader)
        showBezierWave = typedArray.getBoolean(com.scwang.smart.refresh.header.material.R.styleable.MaterialHeader_srlShowBezierWave, showBezierWave)
        scrollableWhenRefreshing = typedArray.getBoolean(com.scwang.smart.refresh.header.material.R.styleable.MaterialHeader_srlScrollableWhenRefreshing, scrollableWhenRefreshing)
        bezierPaint.color = typedArray.getColor(com.scwang.smart.refresh.header.material.R.styleable.MaterialHeader_srlPrimaryColor, Color.parseColor("#11BBFF"))
        if (typedArray.hasValue(com.scwang.smart.refresh.header.material.R.styleable.MaterialHeader_srlShadowRadius)) {
            val radius: Int = typedArray.getDimensionPixelOffset(com.scwang.smart.refresh.header.material.R.styleable.MaterialHeader_srlShadowRadius, 0)
            val color: Int = typedArray.getColor(com.scwang.smart.refresh.header.material.R.styleable.MaterialHeader_mhShadowColor, Color.parseColor("#000000"))
            bezierPaint.setShadowLayer(radius.toFloat(), 0f, 0f, color)
            setLayerType(LAYER_TYPE_SOFTWARE, null)
        }
        showBezierWave = typedArray.getBoolean(com.scwang.smart.refresh.header.material.R.styleable.MaterialHeader_mhShowBezierWave, showBezierWave)
        scrollableWhenRefreshing = typedArray.getBoolean(com.scwang.smart.refresh.header.material.R.styleable.MaterialHeader_mhScrollableWhenRefreshing, scrollableWhenRefreshing)
        if (typedArray.hasValue(com.scwang.smart.refresh.header.material.R.styleable.MaterialHeader_mhPrimaryColor)) {
            bezierPaint.color = typedArray.getColor(com.scwang.smart.refresh.header.material.R.styleable.MaterialHeader_mhPrimaryColor, Color.parseColor("#11BBFF"))
        }
        if (typedArray.hasValue(com.scwang.smart.refresh.header.material.R.styleable.MaterialHeader_mhShadowRadius)) {
            val radius: Int = typedArray.getDimensionPixelOffset(com.scwang.smart.refresh.header.material.R.styleable.MaterialHeader_mhShadowRadius, 0)
            val color: Int = typedArray.getColor(com.scwang.smart.refresh.header.material.R.styleable.MaterialHeader_mhShadowColor, Color.parseColor("#000000"))
            bezierPaint.setShadowLayer(radius.toFloat(), 0f, 0f, color)
            setLayerType(LAYER_TYPE_SOFTWARE, null)
        }
    ...
    fun setBallStyle(style: Int): MaterialHeader = apply {
        ...
        circleDiameter = if (style == BALL_STYLE_LARGE) resources.getDimension(com.hjq.base.R.dimen.dp_56).toInt() else resources.getDimension(com.hjq.base.R.dimen.dp_40).toInt()
