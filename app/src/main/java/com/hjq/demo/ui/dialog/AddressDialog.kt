...
class AddressDialog {
    ...
    class AddressAdapter constructor(context: Context) : AppAdapter<AddressBean?>(context) {
        ...
        override fun onCreateViewHolder(parent: ViewGroup, position: Int): ViewHolder {
            ...
            textView.setPadding(getResources().getDimension(com.hjq.base.R.dimen.dp_20).toInt(), getResources().getDimension(com.hjq.base.R.dimen.dp_10).toInt(),
                getResources().getDimension(com.hjq.base.R.dimen.dp_20).toInt(), getResources().getDimension(com.hjq.base.R.dimen.dp_10).toInt())
