...
class HomeFragment : TitleBarFragment<HomeActivity>(), OnTabListener,
    ...
    override fun onScrimsStateChange(layout: XCollapsingToolbarLayout?, shown: Boolean) {
        ...
        addressView?.setTextColor(ContextCompat.getColor(getAttachActivity()!!, if (shown) com.hjq.base.R.color.black else com.hjq.base.R.color.white))
        ...
        hintView?.setTextColor(ContextCompat.getColor(getAttachActivity()!!, if (shown) com.hjq.base.R.color.black60 else com.hjq.base.R.color.white60))
        searchView?.supportImageTintList = ColorStateList.valueOf(ContextCompat.getColor(getAttachActivity()!!,
            if (shown) R.color.common_icon_color else com.hjq.base.R.color.white))
    }
